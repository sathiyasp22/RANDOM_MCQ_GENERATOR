...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('base', '0002_alter_question_refid'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('question1', models.CharField(blank=True, max_length=300)),
                ('question2', models.CharField(blank=True, max_length=300)),
                ('question3', models.CharField(blank=True, max_length=300)),
                ('question4', models.CharField(blank=True, max_length=300)),
                ('question5', models.CharField(blank=True, max_length=300)),
                ('scoredata', models.IntegerField(blank=True, default=1)),
                ('created_at', models.CharField(blank=True, max_length=200)),
